...
\documentclass[12pt,a4paper,english,czech]{report}
\usepackage[cp1250]{inputenc}
\setcounter{secnumdepth}{3}
\setcounter{tocdepth}{3}
\usepackage{color, xcolor}
\usepackage{babel,epstopdf,graphicx}
\usepackage{verbatim}
\usepackage{prettyref}
\usepackage{float,wrapfig}
\usepackage{calc, units, url, lipsum}
\usepackage{textcomp}
\usepackage{esint}
\usepackage{natbib, nomencl}
...
%\end{comment}
%\begin{figure}[b]
%\begin{comment}\includegraphics[width=0.45\textwidth]{Schema-copy}\includegraphics[width=0.45\textwidth]{instalace}\end{comment}\caption{Schema of functional units (left) and a photo of existing installation
...
\caption{Optimization Tree, neos.mcs.anl.gov}
\label{fig:Optimization-Tree}
\end{wrapfigure}%
...
\begin{figure}
\includegraphics[width=1\textwidth]{oneweekofdata}%
\caption{\label{fig:First-seven-days}%
First seven days of availible data (power production from PV panels from UJV Øež). 
As the data start with Wednesday,
...
%\begin{figure}
%\includegraphics[width=0.45\textwidth]{fittedelectrolyzerplot}
...
\begin{figure}
%\centering{}
\includegraphics[width=0.9\textwidth]{Obrazky/matepsfigFILTERSD}
%\caption{\label{fig:Filtersd} FilterSD solver results.}
\end{figure}
%
\begin{figure}
%\begin{centering}
